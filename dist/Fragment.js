...
function (_Node) {
  ...
  function Fragment() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Fragment)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _dirty.set(_assertThisInitialized(_this), {
      writable: true,
      value: false
    });
  ...
  _createClass(Fragment, [{
    ...
    value: function appendChild() {
      ...
      (_get2 = _get(_getPrototypeOf(Fragment.prototype), "appendChild", this)).call.apply(_get2, [this].concat(args));

      _classPrivateFieldSet(this, _dirty, true);
    }
  }, {
    key: "removeChild",
    value: function removeChild() {
      ...
      (_get3 = _get(_getPrototypeOf(Fragment.prototype), "removeChild", this)).call.apply(_get3, [this].concat(args));
    ...
    value: function reconcile() {
      ...
      if (!_classPrivateFieldGet(this, _dirty)) {
        return;
      }

      _classPrivateFieldSet(this, _dirty, false);
      ...
      try {
        for (var _iterator = this.childNodes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (Array.isArray(node.realNode)) {
            realNode.push.apply(realNode, _toConsumableArray(node.realNode));
          } else {
